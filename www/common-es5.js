...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        value: function getCharacters(offset) {
          return this.http.get("https://breakingbadapi.com/api/characters?limit=10&offset=".concat(offset));
        }
      }, {
        key: "getCharacter",
        ...
        key: "getAuthor",
        value: function getAuthor(author) {
          return this.http.get("https://breakingbadapi.com/api/quote?author=".concat(encodeURI(author)));
        }
      }, {
        key: "getDeath",
        value: function getDeath(search) {
          return this.http.get("https://breakingbadapi.com/api/death-count?name=".concat(encodeURI(search)));
        }
      }]);
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY_1 = 'favouriteEpisodes';
    var STORAGE_KEY_2 = 'favouriteCharacters';
    ...
    var FavouriteService = /*#__PURE__*/function () {
      ...
      _createClass(FavouriteService, [{
        ...
        value: function favouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this.storage.set(STORAGE_KEY_1, result);
            } else {
              return _this.storage.set(STORAGE_KEY_1, [episodeId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteEpisode(episodeId) {
          ...
          return this.getAllFavouriteEpisodes().then(function (result) {
            if (result) {
              ...
              return _this2.storage.set(STORAGE_KEY_1, result);
            }
          });
        }
      }, {
        ...
        key: "isFavouriteC",
        value: function isFavouriteC(characterId) {
        ...
        value: function favouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              return _this3.storage.set(STORAGE_KEY_2, result);
            } else {
              return _this3.storage.set(STORAGE_KEY_2, [characterId]);
            }
          });
        }
      }, {
        ...
        value: function unfavouriteCharacter(characterId) {
          ...
          return this.getAllFavouriteCharacters().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this4.storage.set(STORAGE_KEY_2, result);
            }
          });
        }
      }]);
